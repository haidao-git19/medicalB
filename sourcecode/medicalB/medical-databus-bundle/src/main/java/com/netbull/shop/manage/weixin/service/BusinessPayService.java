...
public class BusinessPayService {
	...
	public String modifyBizStatus(String bizType, String bizCode, String bizState) throws Exception{
	...
	private void modifyConsultation(String bizCode,String bizState){
		...
		requestMap.put("paystate", !NullUtil.isNull(bizState)&&Constants.SUCCESS.equals(bizState)?Constants.CONSULATOIN_PAY_STATE_FINISH:Constants.CONSULATOIN_PAY_STATE_FAIL);
	...
	private void modifySubscribe(String bizCode,String bizState){
		...
		requestMap.put("paystate", !NullUtil.isNull(bizState)&&Constants.SUCCESS.equals(bizState)?Constants.SUBSCRIBE_PAY_STATE_FINISH:Constants.SUBSCRIBE_PAY_STATE_FAIL);
