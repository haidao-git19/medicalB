 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'http://s.maiyaole.com/images/zDialog/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td class="title_div">\
        <div class="closeBtn" onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);">&nbsp;</div>'+this.Title+'</td>\
    </tr>\
    <tr valign="top">\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          ...
          <tr>\
            <td valign="top" align="center"><div id="_Container_' + this.ID + '" style="height: '+(this.Height+8)+'px;position: relative;">\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align:center; background-color:#f6f6f6;">\
                ...
                <input type="button" value="取 消" style="display:none" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
    </tr>\
...
'
	...
	div.style.border = "1px solid #0083ce";
    div.innerHTML = html;
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
        ...
        bgdiv.style.cssText = "position:absolute;left:0px;top:0px;width:100%;height:100%;z-index:2000";
