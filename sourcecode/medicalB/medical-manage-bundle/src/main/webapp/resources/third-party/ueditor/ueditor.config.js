...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL : ctx + '/resources/third-party/ueditor/'

        //图片上传配置区
        ,imageUrl:"/console/imageUpload"             //图片上传提交地址
        //,imagePath: resources + "/resources/upload"       //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imagePath: "http://180.153.55.124:8081/res/upload"       //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , toolbars: [["fullscreen","source","preview","insertimage","emotion","insertvideo","horizontal","spechars","bold","italic","underline","forecolor","justifyleft","justifycenter","justifyright","justifyjustify","inserttable","mergecells"]]
