...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       // , toolbars: [["fullscreen","source","undo","redo","unlink","link","cleardoc","selectall","print","preview","insertimage","emotion","insertvideo","attachment","horizontal","spechars","background","bold","italic","underline","strikethrough","forecolor","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","indent","formatmatch","rowspacingbottom","rowspacingtop","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","mergeright","mergedown","splittorows","mergecells","insertorderedlist"]]
...
//           ]
        ...
        //,maximumWords:1024       //允许的最大字符数
        //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数,留空支持多语言自动切换，否则按此配置显示
        //,wordCountMsg:'当前已输入 {#count} 个字符，您还可以输入{#leave} 个字符'   //当前已输入 {#count} 个字符，您还可以输入{#leave} 个字符
        //超出字数限制提示  留空支持多语言自动切换，否则按此配置显示
       // ,wordOverFlowMsg:'<span style="color:red;">你输入的字符个数已经超出最大允许值，微信服务器可能会拒绝发送！</span>'    //<span style="color:red;">你输入的字符个数已经超出最大允许值，服务器可能会拒绝保存！</span>
